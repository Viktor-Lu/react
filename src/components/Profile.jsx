...
const Profile = () => {
  ...
  < div className={`${classes.item} ${classes.active}`}> My posts</div>
  < div className={classes.item}> New posts</div>
  < div className={classes.item}> Posts1</div>
  < div className={classes.item}> Posts2</div>
</div>
)
}
